...
pub mod slice; // スライス操作（スライスの安全な操作や変換）
pub mod tablet; // タブレットデバイスの検出と操作
pub mod uefi; // UEFI 関連構造体・プロトコル・API呼び出し
pub mod usb; // USBデバイスの検出と操作
pub mod volatile;
...
pub mod xhci; // USBデバイスの検出と操作 // ビット操作やビットフィールドの定義 // メモリマップドI/Oやレジスタ操作のためのボラタイルアクセス
